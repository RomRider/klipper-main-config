...
# it can be flashed via the /dev/btt-octopus-11-407 path, but it then fails
...
cp -f /home/pi/klipper_config/klipper-main-config/boards/btt-octopus-11-407/firmware.config /home/pi/klipper/.config
...
cp -f /home/pi/klipper/out/klipper.bin /home/pi/klipper_config/firmware_binaries/firmware-btt-octopus-11-407.bin
chown pi:pi /home/pi/klipper_config/firmware_binaries/firmware-btt-octopus-11-407.bin
